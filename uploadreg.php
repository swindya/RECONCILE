...
function checkIt()
{
	if (document.form1.fileku[0].value=="" || document.form1.fileku[0].value.length<4 || 
	document.form1.fileku[1].value=="" || document.form1.fileku[1].value.length<4 || 
	document.form1.fileku[2].value=="" || document.form1.fileku[2].value.length<4)
	{
  ...
  <tbody>
	<tr>
      <td style="width: 330px; height: 40px;">
		&nbsp;<span style="font-weight: bold; font-family: Arial;"><form action="movenonmove.php" method="post" enctype="multipart/form-data" name="form0" id="form0"><input type="submit" name="mainmenu" value=" << Menu Utama"></form></span></td>
      <td style="width: 40px; height: 40px;"></td>
      <td style="width: 330px; height: 40px;text-align: right;">
		&nbsp;<span style="font-weight: bold; font-family: Arial;"><form action="login.php" method="post" enctype="multipart/form-data" name="form0" id="form01"><input type="submit" name="logout" value="Logout >>"></form></span></td></td>
    </tr>
  </tbody>
</table>
<br>
<form action="upload_acreg.php" method="post" enctype="multipart/form-data" name="form1" id="form1" OnSubmit="return checkIt();">
<table
 style="width: 700px; text-align: left; margin-left: auto; margin-right: auto;"
 border="0" cellpadding="4" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td style="width: 330px; background-color: rgb(255, 255, 204);">&nbsp;BS4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="fileku[]" type="file" id="fileku" value="Pilih File" size="50" /></td>
    </tr>
    <tr>
      <td style="width: 330px; height: 26px; background-color: rgb(204, 204, 255);"></td>
      <td style="width: 40px;"></td>
...
<div style="text-align: center;"><big
 style="font-family: Arial;"><input type="submit" class="button1" name="Submit" value="Upload & Process" size="50"/></big><br>
</div>
